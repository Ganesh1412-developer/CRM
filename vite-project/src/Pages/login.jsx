...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 p-4">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 bg-gradient-to-r from-purple-500 to-pink-500 p-12 text-white relative overflow-hidden">
          ...
          <div className="absolute top-70 left-32 w-20 h-3 bg-purple-300 rounded-full opacity-70 transform -rotate-30"></div>
          
          {/* Content */}
          <div className="relative z-10">
            <h1 className="text-5xl font-bold mb-6">Welcome to CRM Suite</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <p className="text-center text-gray-600 text-sm">
              ...
              <button 
                ...
                className="text-purple-500 font-semibold hover:text-purple-600 transition"
              >
                Sign up here
              </button>
            </p>
